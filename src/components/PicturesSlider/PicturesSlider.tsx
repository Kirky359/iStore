...
import bannerPurple from '../../assets/main-photos-home-page/iphone-14-pro-purple.png';
import bannerBlack from '../../assets/main-photos-home-page/iphone-14-pro-black.png';
import bannerGold from '../../assets/main-photos-home-page/iphone-14-pro-gold.png';

type Dir = 'prev' | 'next';

const slides = [bannerPurple, bannerBlack, bannerGold];
